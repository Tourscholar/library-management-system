						...
						<ul class="nav navbar-nav navbar-right">
							<li class="dropdown"><a href="#" role="button"
								class="dropdown-toggle" data-hover="dropdown"> <i class="glyphicon glyphicon-user"></i>
								  환영합니다 <% out.write(admin.getName());%> (<%=session.getAttribute("aid")%>)
										<i class="caret"></i></a>
					...
					<div class="col-lg-12">
						<div class="panel panel-default bootstrap-admin-no-table-panel">
							<div class="panel-heading">
								<div class="text-muted bootstrap-admin-box-title">현재 대출 정보</div>
							</div>
							...
							<tbody>
								...
								<td>
									<button type="button" class="btn btn-warning btn-xs"
										data-toggle="modal" onclick="haibook(<%=bean.getHid()%>)">책을 반납</button>
								</td>
							</tbody>
							<%
								}
